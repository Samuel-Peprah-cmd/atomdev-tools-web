...
export default function App() {
  ...
  return (
    ...
    <div className={isDarkMode ? 'dark' : ''}>
      <div className="flex h-screen bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 font-sans overflow-hidden transition-colors duration-300">
        
        {/* RETRACTABLE SIDEBAR */}
        <div className={`${isSidebarOpen ? 'w-64 border-r' : 'w-0'} shrink-0 bg-gray-100 dark:bg-gray-900 border-gray-200 dark:border-gray-800 transition-all duration-300 flex flex-col overflow-hidden`}>
