    ...
    <div className="h-[100dvh] w-full overflow-hidden">
      <div className="relative flex h-full w-full overflow-hidden bg-gray-50 font-sans text-gray-800 transition-colors duration-300 dark:bg-gray-950 dark:text-gray-200">
        ...
        >
          <div className="flex h-full w-[min(19rem,calc(100vw-2.5rem))] flex-col md:w-64">
            ...
            <div className="px-3 mt-auto pt-4 pb-2 border-t border-gray-300 dark:border-gray-800 bg-gray-100 dark:bg-gray-900 shrink-0">
              ...
              {/* BEAUTIFUL CLICKABLE CREDIT BADGE */}
              {authSession && (
                <button 
        ...
        <div className="flex-1 flex flex-col relative h-full min-w-0">
                  ...
                  {showProfileMenu && (
                    <div className="absolute right-0 mt-1 w-48 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg z-50 overflow-hidden">
                      <div className="p-3 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <p className="text-xs text-gray-800 dark:text-gray-200 truncate mt-1">{authSession.user.email}</p>
                      </div>
                      ...
                      <div className="p-1">
                        <button
                          ...
                          className="w-full flex items-center gap-2 px-3 py-2 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors text-left font-medium"
                        >
                          <LogOut size={14} />
                          Sign Out
                        </button>
                      ...
                      <div className="p-1 border-t border-gray-100 dark:border-gray-800 bg-rose-50/50 dark:bg-rose-900/10">
                        <button
                          onClick={handleDeleteAccount}
                          className="w-full flex items-center gap-2 px-3 py-2 text-xs text-rose-600 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-900/30 rounded-lg transition-colors text-left font-medium"
                        >
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 flex flex-col relative custom-scrollbar">
            <div className="max-w-3xl mx-auto w-full flex flex-col flex-1">
              ...
              {/* --- NEW FOOTER --- */}
              <div className="w-full text-center pb-28 sm:pb-32 pt-10 opacity-70 hover:opacity-100 transition-opacity mt-auto">
                <p className="text-[12px] text-gray-500 dark:text-gray-400 flex items-center justify-center gap-1.5 font-medium tracking-wide">
                ...
                <div className="flex items-center justify-center gap-4 text-xs font-semibold mt-3">
      ...
      {/* SUPABASE AUTH MODAL (WITH GOOGLE SIGN IN) */}
      {showAuthModal && (
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 w-full max-w-md rounded-2xl p-6 shadow-2xl relative">
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-sm font-semibold text-gray-700 dark:text-gray-300"
              >
